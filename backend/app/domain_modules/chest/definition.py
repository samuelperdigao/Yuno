...
MODULE_DEFINITION = ModuleDefinition(
    ...
    actions=(
        ActionContract("select_chest", "chest.view", panel_key="global"),
        ActionContract("view_stock", "chest.view", panel_key="global"),
        ActionContract("deposit", "chest.deposit", panel_key="global"),
        ActionContract("withdraw", "chest.withdraw", panel_key="global"),
        ActionContract("history_own", "chest.history_own", panel_key="global"),
    ),
